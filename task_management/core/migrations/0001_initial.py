...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['name', 'start_date', 'end_date'], name='core_projec_name_54e612_idx')],
            },
        ),
        migrations.CreateModel(
            name='Task',
            ...
            options={
                'indexes': [models.Index(fields=['title', 'project', 'due_date'], name='core_task_title_e14353_idx')],
            },
        ),
    ]
